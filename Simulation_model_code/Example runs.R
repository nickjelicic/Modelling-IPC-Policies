...
# returns
#    Focus Bay infections Other bay infections New arrivals Blocked arrivals Unused Bed Days in the focus bay Unused bed days elsewhere in the ward Outbreak occured
...
## returns
#      Focus Bay infections Other bay infections New arrivals Blocked arrivals Unused Bed Days in the focus bay Unused bed days elsewhere in the ward Outbreak occured
#[1,]                    0                    12            7                0                         17.84683                              97.89406                1
#[2,]                    0                    12           13                0                         45.53965                             242.86257               1
