UCLH.SR.allocation.metrics.bgd.infections <- function(background.infection.rate, initial.ward, destination.ward, disease, initial.bay.size, destination.bay.size,
